...
// Auto-Generated 6/22/2022 9:22:17 PM
using UnityEngine;
using UnityEditor;
using OddCommon;
...
namespace com.oddcommon.messaging.editor.tests
{
    public class MessagingControlPanel : EditorWindow
    {
        #region Class
        #region Methods
        [MenuItem("Messaging/Messaging Tests Messaging Control Panel", false, 0)]
        private static void ControlPanelWindow()
        {
            EditorWindow.GetWindow
            (
                typeof(com.oddcommon.messaging.editor.tests.MessagingControlPanel),
                false,
                "Messaging Tests Messaging Control Panel",
                true
            ).Show();
            return;
        }
        ...
        [HideInInspector] [SerializeField] private Quaternion TestMethodInheritancequaternionParam;
        ...
        [HideInInspector] [SerializeField] private TestClassWithNamespace.TestClassWithNamespaceEnum TestMethodNoNamespaceNamespacedParametertestClassWithNamespaceEnum;
        [HideInInspector] [SerializeField] private TestClassNoNamespace.TestClassNoNamespaceEnum TestMethodNoNamespaceRegularParametertestClassNoNamespaceEnum;
        ...
        [HideInInspector] [SerializeField] private Boolean TestMethodBoolParameterboolParam;
        ...
        [HideInInspector] [SerializeField] private SByte TestMethodByteSignedParametersignedByteParam;
        [HideInInspector] [SerializeField] private Byte TestMethodByteUnsignedParameterunsignedByteParam;
        [HideInInspector] [SerializeField] private SByte TestMethodByteParametersignedByteParam;
        [HideInInspector] [SerializeField] private Byte TestMethodByteParameterunsignedByteParam;
        ...
        [HideInInspector] [SerializeField] private Char TestMethodCharParametercharParam;
        ...
        [HideInInspector] [SerializeField] private TestClass TestMethodClassParameterclassPrameter;
        ...
        [HideInInspector] [SerializeField] private Double TestMethodDoubleParameterdoubleParam;
        ...
        [HideInInspector] [SerializeField] private TestEnum TestMethodEnumParameterenumParam;
        ...
        [HideInInspector] [SerializeField] private Single TestMethodFloatParameterfloatParam;
        ...
        [HideInInspector] [SerializeField] private GameObject TestMethodGameObjectParametergameObjectParameter;
        ...
        [HideInInspector] [SerializeField] private Int32 TestMethodIntSignedParametersignedIntParam;
        [HideInInspector] [SerializeField] private UInt32 TestMethodIntUnsignedParameterunsignedIntParam;
        [HideInInspector] [SerializeField] private Int32 TestMethodIntParametersignedIntParam;
        [HideInInspector] [SerializeField] private UInt32 TestMethodIntParameterunsignedIntParam;
        ...
        [HideInInspector] [SerializeField] private Int64 TestMethodLongSignedParametersignedLongParam;
        [HideInInspector] [SerializeField] private UInt64 TestMethodLongUnsignedParameterunsignedLongParam;
        [HideInInspector] [SerializeField] private Int64 TestMethodLongParametersignedLongParam;
        [HideInInspector] [SerializeField] private UInt64 TestMethodLongParameterunsignedLongParam;
        ...
        [HideInInspector] [SerializeField] private MonoBehaviour TestMethodMonoBehaviourParametermonoBehaviourParameter;
        ...
        [HideInInspector] [SerializeField] private OddBehaviour TestMethodOddBehaviourParameteroddBehaviourParameter;
        ...
        [HideInInspector] [SerializeField] private TestClassOddBehaviourSingle TestMethodOddBehaviourSingletonParameteroddBehaviourSingleParameter;
        ...
        [HideInInspector] [SerializeField] private OddScriptableObject TestMethodOddScriptableObjectParameteroddScriptableObjectParameter;
        ...
        [HideInInspector] [SerializeField] private TestClassOddScriptableObjectSingle TestMethodOddScriptableObjectSingletonParameteroddScriptableObjectSingletonParameter;
        ...
        [HideInInspector] [SerializeField] private Quaternion TestMethodQuaternionParameterquaternionParam;
        ...
        [HideInInspector] [SerializeField] private ScriptableObject TestMethodScriptableObjectParameterscriptableObjectParameter;
        ...
        [HideInInspector] [SerializeField] private Int16 TestMethodShortSignedParametersignedShortParam;
        [HideInInspector] [SerializeField] private UInt16 TestMethodShortUnsignedParameterunsignedShortParam;
        [HideInInspector] [SerializeField] private Int16 TestMethodShortParametersignedShortParam;
        [HideInInspector] [SerializeField] private UInt16 TestMethodShortParameterunsignedShortParam;
        ...
        [HideInInspector] [SerializeField] private String TestMethodStringParameterstringParam;
        ...
        [HideInInspector] [SerializeField] private TestStruct TestMethodStructParameterstructParam;
        ...
        [HideInInspector] [SerializeField] private UnityEngine.Object TestMethodUnityEngineObjectParameterunityEngineObjectParameter;
        ...
        [HideInInspector] [SerializeField] private Vector2 TestMethodVector2Parametervector2Param;
        [HideInInspector] [SerializeField] private Vector3 TestMethodVector3Parametervector3Param;
        [HideInInspector] [SerializeField] private Vector4 TestMethodVector4Parametervector4Param;
        [HideInInspector] [SerializeField] private Vector2Int TestMethodVector2IntParametervector2IntParam;
        [HideInInspector] [SerializeField] private Vector3Int TestMethodVector3IntParametervector3IntParam;
        ...
        [HideInInspector] [SerializeField] private Int32[] TestMethodIntArrayParameterarrayParam;
        ...
        [HideInInspector] [SerializeField] private TestClassWithNamespace.TestClassWithNamespaceEnum TestMethodInNamespaceNamespacedParametertestClassWithNamespaceEnum;
        [HideInInspector] [SerializeField] private TestClassNoNamespace.TestClassNoNamespaceEnum TestMethodInNamespaceRegularParametertestClassNoNamespaceEnum;
        ...
        private void OnGUI()
        {
            ...
            if(this.foldoutToggleTestInterfaceOddBehaviourSingletonParameter)
            {
                ...
                SerializedProperty serialized_TestMethodOddBehaviourSingletonParameteroddBehaviourSingleParameter = serializedEditorWindow.FindProperty("TestMethodOddBehaviourSingletonParameteroddBehaviourSingleParameter");
                EditorGUILayout.PropertyField(serialized_TestMethodOddBehaviourSingletonParameteroddBehaviourSingleParameter, new GUIContent("oddBehaviourSingleParameter"), true);;
                EditorGUILayout.BeginHorizontal();
                GUILayout.Space(EditorGUI.indentLevel * MessagingConstants.controlPanelButtonsOffset);
                if (Application.isPlaying & GUILayout.Button("Fire TestMethodOddBehaviourSingletonParameter Event "))
                {
                    if (messagingManager != null)
                    {
                        messagingManager.TestMethodOddBehaviourSingletonParameterEvent(this.TestMethodOddBehaviourSingletonParameteroddBehaviourSingleParameter);
                    }
                    else
                    {
                        Logging.Warn
